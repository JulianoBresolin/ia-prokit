...
export default function HelpChatImgRest() {
	return (
		<>
			<Dialog>
				...
				<DialogContent className="max-w-[425px] md:max-w-[625px] lg:max-w-[725px]">
					...
					<div className="overflow-y-auto max-h-[calc(100vh-400px)] ">
						<section id="como-usar">
							<ol>
								<li>
									<strong>Iniciar uma Restauração de foto:</strong>
									Envie uma foto através do formulario e clique no botão enviar
									para interagir com o modelo de i.a. Aguarde sua foto ser
									restaurada. Você poderá fazer o download após a resposta do
									modelo de i.a.
								</li>
						...
						<section id="cobranca">
							...
							<ol>
								...
								<li>
									<strong>Valores:</strong>Cada pedido de foto para ser
									restaurada custa 25 tokens.
								</li>
								<li>
