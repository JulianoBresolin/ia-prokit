	...
	return (
		<div
			className={` z-30 my-20 mb-40 lg:mb-10 mx-auto max-w-max md:max-w-screen-sm
                        ...
                        flex px-3 md:px-4 py-3 justify-between items-center flex-col sm:flex-row gap-4 bg-purple-800 rounded-lg shadow`}
		>
			<div className="text-center bold text-lg text-white hover:underline">
