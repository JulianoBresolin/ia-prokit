export default function PoliticaDePrivacidade() {
	return (
		<>
			<section className=" text-white my-20 pb-32 mx-10">
				<h1 className=" text-2xl font-bold mb-10 ">Politica de Privacidade</h1>
				<p>
					A sua privacidade é importante para nós. É política do I.A Prokit
					respeitar a sua privacidade em relação a qualquer informação sua que
					possamos coletar no site I.A Prokit, e outros sites que possuímos e
				...
				<br></br>
				<h2>Política de Cookies I.A Prokit</h2>
				<br></br>
				...
				<p>
					...
					para que possamos continuar produzindo conteúdo atraente. Para mais
				...
				<p>
					...
					informação que o I.A Prokit oferece no site e com caráter enunciativo,
					mas não limitativo:
				</p>
				<ul>
					{" "}
					...
					<li>
						...
						softwares do I.A Prokit, de seus fornecedores ou terceiros, para
				...
				<br></br>
				<p>
					Esta política é efetiva a partir de <strong>Dez</strong>/
					<strong>2023</strong>.
				</p>
			</section>
		</>
